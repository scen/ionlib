...
protected:
	...
	void On_FileAdded(const std::string & strFileName);
	void On_FileRemoved(const std::string & strFileName);
	void On_FileModified(const std::string & strFileName);
	void On_FileNameChanged(const std::string & strOldFileName, const std::string & strNewFileName);
	void On_ReadDirectoryChangesError(DWORD dwError, const std::string & strDirectoryName);

	void On_WatchStarted(DWORD dwError, const std::string & strDirectoryName);
	void On_WatchStopped(const std::string & strDirectoryName);
	

	void SetChangedDirectoryName(const std::string & strChangedDirName);
	const std::string & GetChangedDirectoryName()const;
	...
	void SetPartialPathOffset(const std::string & strWatchedDirName);
