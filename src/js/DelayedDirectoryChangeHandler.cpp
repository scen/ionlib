...
void CDelayedDirectoryChangeHandler::SetPartialPathOffset(const std::string & strWatchedDirName)
{
...
void CDelayedDirectoryChangeHandler::On_FileAdded(const std::string & strFileName)
{
...
void CDelayedDirectoryChangeHandler::On_FileRemoved(const std::string & strFileName)
{
	CDirChangeNotification * p = GetNotificationObject();
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_FileModified(const std::string & strFileName)
{
	CDirChangeNotification * p = GetNotificationObject();
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_FileNameChanged(const std::string & strOldFileName, const std::string & strNewFileName)
{
	CDirChangeNotification * p = GetNotificationObject();	
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_ReadDirectoryChangesError(DWORD dwError, const std::string & strDirectoryName)
{
	CDirChangeNotification * p = GetNotificationObject();
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_WatchStarted(DWORD dwError, const std::string & strDirectoryName)
{
...
void CDelayedDirectoryChangeHandler::On_WatchStopped(const std::string & strDirectoryName)
{
...
void CDelayedDirectoryChangeHandler::SetChangedDirectoryName(const std::string & strChangedDirName)
{
	ASSERT( m_pRealHandler );
...
const std::string & CDelayedDirectoryChangeHandler::GetChangedDirectoryName() const
{
	if( m_pRealHandler )
